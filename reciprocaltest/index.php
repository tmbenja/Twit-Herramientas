...
//      }
         ...
         If (count($traidores) != 0) {
            ...
            if (count($traidores) > 100) {
               Echo("<p align=\"center\">Sigues a más de 100 ególatras.<br />
         ...
         <form name="unfollow" action="?action=unfollow" method="POST">
            <table cellspacing="15px" cellpadding="0" style="border: 1px solid #8ec1da; background-color: #c0deed" align="center">
               <tbody>
                  <tr><th colspan="2" style="text-align: center">Tienes <?= count($traidores) ?> ególatras entre tus followers:</th></tr>
                  <tr>
                     <td>&nbsp;</td>
		...
		if (isset($_SESSION["friends"]["ids"]) && is_array($_SESSION["friends"]["ids"]) && count($_SESSION["friends"]["ids"]) != 0) {
            ...
            <table align="center" cellspacing="50px"><tbody>
                  <tr>
                     ...
                     <td>
                        <p>El "Test de reciprocidad" es una herramienta que coteja los usuarios que sigues con los que te siguen a tí.<br />
                           De esta manera puedes averiguar facilmente que usuarios seguiste pero no te devolvieron el follow, y analizar si merece la pena seguir siguiéndolos.
                        </p>
                     </td>
                  </tr>
                  <tr><th colspan="2"><button onclick="location.href='?action=start'"><? $mensajes = array("¡Empezar!", "¡Dale Caña!", "Ver mi colección de ególatras", "¡Enséñamelos!", "Ok pipol, press estart");
